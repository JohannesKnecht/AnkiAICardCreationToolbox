...
PROJECT_KNOWLEDGE_DIR = f"src/ankiaicardcreationtoolboxbackend/data"
...
knowledge_base_config = {
    ...
    ANKI_FORMATTING_GUIDELINES: {
        ...
        "additional_info": "Focus only on text files and providing a document that can be used to create such text files. The goal is to create text files, not to ingest them.",
    },
}